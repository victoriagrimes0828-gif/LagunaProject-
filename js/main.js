...
function applySiteConfig() {
  ...
  setText('[data-site="victoria-email"]', cfg.victoriaEmail);
  setText('[data-site="donna-email"]', cfg.donnaEmail);
  setText('[data-site="tiffany-email"]', cfg.tiffanyEmail);
  setText('[data-site="order-tracking-name"]', cfg.orderTrackingName);
  setText('[data-site="order-tracking-email"]', cfg.orderTrackingEmail);
  ...
  document.querySelectorAll('[data-site-link="victoria-email"]').forEach(function (el) {
    el.setAttribute('href', 'mailto:' + cfg.victoriaEmail);
  });
  document.querySelectorAll('[data-site-link="donna-email"]').forEach(function (el) {
    el.setAttribute('href', 'mailto:' + cfg.donnaEmail);
  });
  document.querySelectorAll('[data-site-link="tiffany-email"]').forEach(function (el) {
    el.setAttribute('href', 'mailto:' + cfg.tiffanyEmail);
  });
  document.querySelectorAll('[data-site-link="order-tracking-email"]').forEach(function (el) {
    el.setAttribute('href', 'mailto:' + cfg.orderTrackingEmail);
  });
